import type { ISODateString, ReschedulePolicy } from "@/types";
...
export type RescheduleRefusalReason = (typeof RESCHEDULE_REFUSAL_REASONS)[number];

/** O que a equipe lê no alerta quando o pedido não pôde ser automático. */
export const RESCHEDULE_REFUSAL_LABELS: Record<RescheduleRefusalReason, string> = {
...
export function rescheduleHoldEndsAt(now: ISODateString): ISODateString {
