...
export const SYSTEM_RULES = [
    systemRule({
        ...
        description: "O agente opera exclusivamente dentro do tenant da conversa. Qualquer leitura fora dele é negada pelas Security Rules antes de chegar ao motor.",
        level: "SECURITY",
        category: "PRIVACY",
        priority: 1000,
    ...
    systemRule({
        ...
        description: "O agente não realiza nenhuma ação que o papel do profissional responsável não autorize.",
        level: "SECURITY",
        category: "PRIVACY",
        priority: 990,
        conditions: { combinator: "AND", conditions: [] },
    ...
    systemRule({
        ...
        description: "Dados de outros clientes, informações financeiras de terceiros e conteúdo de conversas nunca são divulgados.",
        level: "SECURITY",
        category: "PRIVACY",
        priority: 980,
        conditions: { combinator: "AND", conditions: [] },
    ...
    systemRule({
        ...
        description: "O agente responde apenas com informação presente nas regras ativas ou nos dados da organização. Sem fonte, escala.",
        level: "SYSTEM",
        category: "SAFETY",
        priority: 900,
        conditions: { combinator: "AND", conditions: [] },
    ...
    systemRule({
        ...
        description: "O agente se identifica como assistente em toda resposta automática. Não assina como o profissional.",
        level: "SYSTEM",
        category: "IDENTITY",
        priority: 890,
        conditions: { combinator: "AND", conditions: [] },
    ...
    systemRule({
        ...
        description: "Mensagem classificada como possível risco interrompe a automação, gera alerta crítico e aguarda o profissional.",
        level: "SYSTEM",
        category: "ESCALATION",
        priority: 880,
        conditions: {
    ...
    systemRule({
        ...
        description: "Somente mensagens classificadas como administrativas podem receber resposta automática. Qualquer outra classificação vai para o profissional.",
        level: "SYSTEM",
        category: "SAFETY",
        priority: 870,
        conditions: {
    ...
    systemRule({
        ...
        description: "Intenção não reconhecida ou confiança abaixo do limite configurado sempre resulta em encaminhamento ao profissional.",
        level: "SYSTEM",
        category: "ESCALATION",
        priority: 860,
        conditions: {
    ...
    systemRule({
        ...
        description: "A precedência entre níveis é resolvida pelo motor. Uma regra do profissional não pode liberar o que uma regra fundamental proíbe.",
        level: "SYSTEM",
        category: "SAFETY",
        priority: 850,
        conditions: { combinator: "AND", conditions: [] },
...
export function materializeSystemRules(organizationId, now) {
 ...
 */
export function materializeProfessionRules(organizationId, profession, now) {
...
export function materializeSeededRules(organizationId, profession, now) {
    return [
