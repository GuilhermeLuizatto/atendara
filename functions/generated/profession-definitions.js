...
export const PROFESSION_DEFINITIONS = {
    PSYCHOLOGIST: {
        ...
        officialTaxReceipt: "RECEITA_SAUDE",
        ...
        suggestedRules: [
            {
                ...
                description: "Alergia, irritação, inflamação ou corte depois do atendimento vira alerta para a profissional.",
                category: "ESCALATION",
                action: "ESCALATE",
                enabled: true,
            },
